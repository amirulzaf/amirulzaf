...
<div class="w3-container" id="layout">
  ...
  <?php 
  $tablerow_sql = mysqli_query($db, "SELECT * from tablerow where ground_id=2 GROUP BY table_row limit 3");
  $i=0;
 ...
 ?>
    <li class="row">
      <ol class="seats" type="A">
        <?php 
          $i++;
          $table_sql = mysqli_query($db,"SELECT* FROM tablerow where table_row = $i AND ground_id=2 limit 3");
...
<hr>	 
    ...
    <li>
      <div id="triangle-bottomleft">
        <span class="stairs">Stairs</span>
      </div>
    </li>
    <div>
  <?php 
  $tablerow_sql = mysqli_query($db, "SELECT * from tablerow where ground_id=2 GROUP BY table_row ");
  $i=3;
  while($table_row=mysqli_fetch_assoc($tablerow_sql )){   
 ?>
    <li class="row">
      <ol class="seats" type="A">
        <?php 
          $i++;
          $table_sql = mysqli_query($db,"SELECT* FROM tablerow where table_row = $i AND ground_id=2");
